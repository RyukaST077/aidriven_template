---
description: "Prompt for Release & Operation Phase (Role: SRE)"
agent: agent
...
1. `docs/01_Project_Design/03_Architecture.md`（アーキテクチャ設計）：インフラ構成・デプロイ方式
2. `docs/01_Project_Design/04_Basic_Design.md`（基本設計）：システム構成・外部連携
3. `docs/01_Project_Design/10_Security_Design.md`（セキュリティ設計）：監査ログ・アクセス制御
4. 最初の回答は以下を必ず含める：
