---
description: "Prompt for Specification Phase (Role: Business Analyst)"
agent: agent
...
* 現在のエディタで開いているファイルや、`@workspace` 等で参照された資料を読み、重要情報を抽出して整理する（文書分析）。
