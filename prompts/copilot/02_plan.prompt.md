---
description: "Prompt for Architecture Phase (Role: Solution Architect)"
agent: agent
...
1. `docs/01_Project_Design/01_Requirements.md`（要件定義）を読み込み（`@workspace` や開いているファイルから）、BREQ/FR/NFR/CON/ACを把握する。
