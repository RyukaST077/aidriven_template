...
- 方式設計・基本設計：**設計（How）**
- 画面設計・帳票設計・IF設計・データ設計：**仕様の具体化（How）**
...
| BR-ID | 要求（1文） | 成功指標(KPI) | 優先度 | 根拠/出典 | 関連業務フロー |
|---|---|---|---|---|---|
| BR-001 |  |  | Must |  | BF-xx |
...
|---|---|---|---|---|---|---|---|
| FR-001 |  | システムは…の場合…すること | Must |  | 入：/出： | BR-001, RULE-xx, UI-xx | AC-001 |
...
- 関連：BR-xxx / 業務フローBF-xx / 業務ルールRULE-xx / 画面UI-xx / IF-xx
- 受入条件：AC-xx 参照
...
| BR | FR | 画面/IF/帳票 | 設計（基本/方式/詳細） | テスト（計画/仕様/ケース） | AC |
|---|---|---|---|---|---|
| BR-001 | FR-001 | UI-01 | BD-xx / ARCH-xx | TC-xxx | AC-001 |
...
## 付録B：業務例外カタログ（要件レベル）
| EXC-ID | 例外シナリオ | 期待するシステム動作（要件） | 参照（業務ルール） |
|---|---|---|---|
| EXC-001 |  |  | RULE-xx |
